    ...
    <div class="module">
        ...
        <div class="row">
            <div class="module-body column">
                <h2 style="text-align:center; font-family:'Times New Roman', Times, serif">Jurusan sekolah</h2>
                <form class="form-horizontal row-fluid">
                   
                    <div class="control-group">
                        <label class="control-label">Nama</label>
                        <div class="controls">
                            <input type="text" id="branch" data-form-field="branch" placeholder="Masukan jurusan disini..." class="span12">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addBranch">Tambah jurusan</button>
                        </div>
                    </div>
                </form>
                <br>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('student.destroy', $branch->id) }}" method="Post">
                                        @csrf
                                        @method('Delete')
                                        <p>Kamu yakin ingin hapus ({{ $branch->branch }}) Jurusan ? </p>
            ...
            <div class="module-body column">
                ...
                <form class="form-horizontal row-fluid">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="student_category" data-form-field="student_category" placeholder="Masukan kategori buku disini..." class="span12">
                            <input type="hidden"  data-form-field="token"  value="{{ csrf_token() }}">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Maximum di izinkan</label>
                        <div class="controls">
                            <input type="number" id="max_allow" data-form-field="max_allowed" placeholder="Masukan maximum yang di izinkan" class="span12">
                        </div>
                    </div>
    
                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addStudentCategory">Tambah kategori siswa</button>
                        </div>
                    </div>
                </form>
                <br>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('student.destroy', $student_category->cat_id) }}" method="Post">
                                    @csrf
                                    @method('Delete')
                                    <p>Kamu yakin ingin menghapus  ({{ $student_category->category }}) Kategori siswa ? </p>
