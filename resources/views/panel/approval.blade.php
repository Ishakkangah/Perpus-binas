...
<div class="content">
    <div class="module">
        <div class="module-head">
            <h3>SISWA MENUNGGU PERSETUJUAN AKSES KE PERPUSTAKAAN</h3>
        </div>
        <div class="module-body">
            <div class="controls">
                ...
                <select class="span2" id="year_select">
                    ...
                    <button style="margin-bottom:10px" id="refresh" class="btn btn-info">Refresh</button>
