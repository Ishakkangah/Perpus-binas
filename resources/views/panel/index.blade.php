    ...
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <button class="btn-box span12" style="background: #9400D3; ">
                <b style="color:#fff">SISTEM MANAJEMEN PERPUSTAKAAN ONLINE</b>
            </button>
        </div>
                ...
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            <label class="control-label">judul atau penulis<br>buku</label>
                            <div class="controls">
                                <div class="span9">
                                    <textarea class="span12" rows="2" placeholder="ketikan judul atau penulis buku"></textarea>
                                </div>
                                <div class="span3">
                ...
                <div class="module-body">
                    <form class="form-horizontal row-fluid" id="findissueform">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="number" placeholder="" class="span9" placeholder="masukan ID buku">
                                <a class="btn homepage-form-submit" style="background-color:  #9400D3; color:#fff"><i class="icon-search"></i> Cari</a>
                            </div>
                        </div>
                    </form>
